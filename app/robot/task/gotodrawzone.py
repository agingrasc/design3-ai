...
class go_to_drawzone(task):
    ...
    def _find_path(self):
        ...
        self.next_state = self._go_to_drawzone

    def _go_to_drawzone(self):
        print("going to drawzone Command")
        print(self.x_drawzone)
        print(self.y_drawzone)
        ...
        if self._distance(self.x_robot_position, self.y_robot_position, self.x_drawzone, self.y_drawzone) <= 2:
