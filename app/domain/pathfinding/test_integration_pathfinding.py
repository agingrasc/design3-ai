...
class PathFindingITest(TestCase):
    def test_initialise_weight_one_obstacle(self):
        obstacle = ObstacleValueObject(
            pos_x=9, pos_y=4, radius=2, tag=Tag.CANT_PASS_LEFT)
    ...
    def test_find_obstacle(self):
        ...
        end_position = game_board.game_board[50][8]
    ...
    def test_find_left_obstacle(self):
        obstacle = ObstacleValueObject(
            pos_x=19, pos_y=14, radius=3, tag=Tag.CANT_PASS_LEFT)
    ...
    def test_find_extrem_left_right_obstacles(self):
        obstacle1 = ObstacleValueObject(
            pos_x=19, pos_y=20, radius=3, tag=Tag.CANT_PASS_LEFT)
        obstacle2 = ObstacleValueObject(
            pos_x=39, pos_y=10, radius=3, tag=Tag.CANT_PASS_RIGHT)
    ...
    def test_find_left_rightx2_obstacles(self):
        obstacle1 = ObstacleValueObject(
            pos_x=8, pos_y=20, radius=3, tag=Tag.CANT_PASS_LEFT)
        obstacle2 = ObstacleValueObject(
            pos_x=39, pos_y=10, radius=3, tag=Tag.CANT_PASS_RIGHT)
        obstacle3 = ObstacleValueObject(
            pos_x=19, pos_y=10, radius=3, tag=Tag.CANT_PASS_RIGHT)
    ...
    def test_real_value_no_obstacle(self):
        obstacle1 = ObstacleValueObject(
            pos_x=50, pos_y=50, radius=3, tag=Tag.CANT_PASS_RIGHT)
    ...
    def test_no_obstacle_verticable(self):
        obstacle1 = ObstacleValueObject(
            pos_x=5, pos_y=5, radius=1, tag=Tag.CANT_PASS_RIGHT)
        game_board = GameBoard(23, 11, [obstacle1])

        end_position = game_board.game_board[14][4]
        begin_position = game_board.game_board[7][5]
