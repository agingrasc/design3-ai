...
class IdentifyAntennaTaskTest(unittest.TestCase):
    def setUp(self):
        ...
        self.pathfinding_application_service.find.side_effect = [VALID_PATH_START, VALID_PATH_END]
    ...
    def test_call_pathfinder_correctly(self):
        ...
        expected_calls = [
            call(self.global_information, self.start_antenna_position), call(self.global_information, self.end_antenna_position)
        ]
